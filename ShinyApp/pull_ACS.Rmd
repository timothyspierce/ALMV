...
```{r}
save(all_ACS5,file="data/all_ACS5.Rda")
...
```{r}
saveRDS(all_ACS5, "data/all_ACS5.rds")
...
save(state_list, all_ACS5, file = "data/ACS_Objects.RData")
...
```{r}
save.image(file = "data/pull_ACS5.RData") 
```
